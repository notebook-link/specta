...
export const SettingContent = React.memo(
  (props: {
    ...
    return (
      <div style={{ padding: '0 10px' }}>
        ...
        <Divider />
        {(props.spectaConfig?.topBar?.layoutToggle !== undefined
          ? props.spectaConfig?.topBar.layoutToggle
          : true) &&
          layoutRegistry && (
            <div>
        ...
        {(props.spectaConfig?.topBar?.themeToggle !== undefined
          ? props.spectaConfig?.topBar?.themeToggle
          : true) &&
          themeManager && (
            <div>
              <label htmlFor="">
